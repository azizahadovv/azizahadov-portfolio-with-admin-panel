...
const AdminPanel = () => {
  ...
  const handleLogin = (e) => {
    ...
    if (
      ...
      credentials.password === "Relax0619."
    ) {
  ...
  const { data: contactsData = { data: [] }, isLoading } = useQuery({
          ...
          >
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-portfolio-gray-400 mb-2">
                  No Messages Yet
                </h3>
                <p className="text-portfolio-gray-500">
              ...
              <div className="grid gap-4">
                {contacts?.map((contact, index) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-portfolio-gray-400">
                            {contact?.email}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="mb-3">
                      <h4 className="font-medium text-dark-red mb-1">
                        Subject:
                      </h4>
                    ...
                    <div>
                      ...
                      <p className="text-portfolio-gray-300 leading-relaxed">
                        {contact?.message}
                      </p>
                    </div>
        ...
        <div className="md:col-span-3 space-y-6">
          <div className="bg-portfolio-gray-900 p-6 rounded-xl border border-portfolio-gray-700">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-lg font-mono text-dark-blue">
                {currentEndpoint.url}
              </span>
            </div>
            <p className="text-portfolio-gray-300">
...
.then(data => console.log(data));`}
  ...
  ${window.location.origin}${currentEndpoint.url} \\${
                      currentEndpoint.requestBody
                        ? `
    ...
    >
      ...
      <div className="bg-portfolio-gray-900 p-6 rounded-xl border border-portfolio-gray-700">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-portfolio-gray-800 rounded-lg">
            ...
            <p className="text-sm text-portfolio-gray-300">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center space-x-3 p-3 bg-blue-900/20 border border-blue-500/30 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-portfolio-gray-300">
                Switched from in-memory to persistent storage
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-portfolio-gray-900 p-6 rounded-xl border border-portfolio-gray-700">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            <h4 className="font-medium text-dark-blue mb-2">
              ORM Configuration
            </h4>
            <pre className="bg-portfolio-gray-800 p-3 rounded text-sm text-green-400">
